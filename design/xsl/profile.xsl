...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<div class="marks-box">
		<ul class="bonusmark">
			<li class="l" id="log1"> <xsl:if test="type='profile'"> <xsl:attribute name="class">l active</xsl:attribute> </xsl:if> Личная информация<div class="line"></div></li>
			<li id="log2"><xsl:if test="type='bonuses' or coupon/ok!=''"> <xsl:attribute name="class">active</xsl:attribute> </xsl:if> Купоны<div class="line"></div></li>
			<li class="log3" id="log3"> <xsl:if test="type='friends'"> <xsl:attribute name="class">active</xsl:attribute> </xsl:if> Друзья<div class="line"></div></li>
		</ul>	
				...
				<div class="right">
					...
					<xsl:if test="@used='' and @ownerId!='57'">
						...
						<xsl:if test="@paid=1">
							...
							<xsl:choose>
								<xsl:when test="@ldate=1"> </xsl:when>
