			...
			if($html=='')
			{
				...
				if ($this->krnl->fDbExecute())
				{
					...
					// 78056ebb02cffc14bb7ece14904812dc - bonus EMAIL-спам
					{
						...
						if($pass == 'mouse')
							$this->fieldsData['marking'] = 'EMAIL 24.04.2012';
						else $this->fieldsData['marking'] = 'SMS 24.04.2012';
...
$text = '<table width="100%" cellspacing="0" cellpadding="5" border="0" style="font:14px Segoe UI,Arial,Verdana,sans-serif;" bgcolor="#FFF">
	<tr>
...
'<table width="100%" cellspacing="0" cellpadding="5" border="0" style="font:14px Segoe UI,Arial,Verdana,sans-serif;" bgcolor="#FFF"> <tr> <td align="center" valign="middle"> <table width="678" cellspacing="8" cellpadding="0" border="0" bgcolor="#EDF3F5"> <tr> <td align="center" valign="middle" bgcolor="#EDF3F5"> <table width="662" cellspacing="0" cellpadding="0" bgcolor="#FFF"> <col width="35"/><col width="307"/><col width="285"/><col width="35"/> <tr> <td height="100"></td> <td> </td> <td align="right"> <a href="'.$this->krnl->domainName.'" title="BonuseMouse.ru" align="center"><img src="'.$this->krnl->domainName.'image/metro/logo.png" alt="bonusmouse.ru"/></a> </td> <td></td> </tr> </table> <table width="662" cellspacing="0" cellpadding="0" bgcolor="#FFF"> <tr> <td height="300" align="center" valign="middle"> <h1 style="font-weight:normal;font-size:22px;margin:0;color:#000;">Поздравляем!</h1> <p style="font-weight:normal;font-size:22px;margin:0 0 20px;">Вы успешно активировали аккаунт на <strong>bonusmouse.ru</strong></p> <h2 style="font-weight:normal;font-size:18px;margin:0 0 10px;">Мы дарим Вам 50 рублей и билет в кино</h2> <img src="'.$this->krnl->domainName.'image/metro/50rub.png" alt="Мы дарим Вам 50 рублей" style="margin:0 20px;"/> <img src="'.$this->krnl->domainName.'image/metro/ticket.png" alt="Мы дарим Вам билет в кино" style="margin:0 20px;"/> </td> </tr> </table> </td> </tr> </table> </td> </tr> </table>';
				...
				return '<ok><![CDATA[Активация аккаунта успешно завершена. Добро пожаловать на сайт bonusmouse.ru. <br/> <span class="h4">На Ваш счет зачислены <span class="bold">50 рублей</span><br/>A так же в разделе <a href="'.$this->krnl->domainName.'/mybonuses.html">купоны</a> Вы найдете купон дающий право на <span class="bold">бесплатный билет в кинотеатр.</span></span>]]></ok>';
			}
...
'<table width="100%" cellspacing="5" cellpadding="5" border="0" style="font:14px Segoe UI,Arial,Verdana,sans-serif;" bgcolor="#FFF">
	<tr>
		<td align="center" valign="middle">
