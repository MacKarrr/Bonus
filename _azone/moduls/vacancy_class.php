<?
class cVacancy extends cModule
{
	...
	function fCreateModule() 
	{
		...
		$this->moduleCaption = 'вакансии';

		$this->searchFeatures = array('fields'=>array('name', 'descr'), 'description'=>'descr', 'name'=>'name', 'pref'=>'vacancy.html#', 'suff'=>'');
	...
	function fDisplay()
	{
		...
		return fXmlTransform($xml,'vacancy');
	}
